...
def find_fixed_points(model, state_traj):
    ...
    init_states = fp_finder.sample_states(state_traj, n_inits=n_inits, noise_scale=0.5)
    ext_inp = torch.zeros(n_bits)
    unique_fps, all_fps = fp_finder.find_fixed_points(init_states, ext_inp)
